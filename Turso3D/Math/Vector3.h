...
public:
    ...
    float AbsDotProduct(const Vector3& rhs) const { return Turso3D::Abs(x * rhs.x) + Turso3D::Abs(y * rhs.y) + Turso3D::Abs(z * rhs.z); }
    ...
    Vector3 Abs() const { return Vector3(Turso3D::Abs(x), Turso3D::Abs(y), Turso3D::Abs(z)); }
